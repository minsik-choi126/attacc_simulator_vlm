...
Current paper pass reports A1/TP=1 only. A2/TP=2 efficiency can be restored
from the same formula later if the future TP=2 validation path is enabled.
"""
import sys
import pathlib
...
def main():
    ...
    for cfg in MODELS:
        ...
        # Run A1 with full eff_lat applied
        m = sr.run(
